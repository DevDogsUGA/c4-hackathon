...
// info:   extra context, safe to ignore. See the `MoveInfo` type in
//         types.ts -- notably `info.clockRemainingMs`, your remaining
//         think-time budget for THIS GAME (not this move).
//
